  ...
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert('Rooms', [
      ...
      },
      {
        ...
        description: 'Set amongst the tropical greenery of Ubud in the middle of it’s perfect rice fields, this brand new modern villa will offer you serenity and peace with its infinity pool looking onto the lush greenery valley view.',
        price: 339.00,
      },
      {
        ownerId: 7,
