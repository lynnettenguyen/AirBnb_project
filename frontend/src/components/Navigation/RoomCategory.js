  ...
  return (
    <div className="categories-nav-outer">
      <div className="category-scroll">
        {/* <Slider {...settings}> */}
        <div className={category === 'A-Frames' ? "room-category-selected" : "room-category-outer"} onClick={() => handleFilter('A-Frames')}>
        ...
        <div className={category === 'Amazing Pools' ? "room-category-selected" : "room-category-outer"} onClick={() => handleFilter('Amazing Pools')}>
        ...
        <div className={category === 'Cabins' ? "room-category-selected" : "room-category-outer"} onClick={() => handleFilter('Cabins')}>
        ...
        <div className={category === 'Domes' ? "room-category-selected" : "room-category-outer"} onClick={() => handleFilter('Domes')}>
        ...
        <div className={category === 'Treehouses' ? "room-category-selected" : "room-category-outer"} onClick={() => handleFilter('Treehouses')}>
        ...
        <div className={category === 'Tiny Homes' ? "room-category-selected" : "room-category-outer"} onClick={() => handleFilter('Tiny Homes')}>
